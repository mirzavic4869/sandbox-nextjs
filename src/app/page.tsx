...
export default function Home() {
  ...
  return (
    <main className="mx-auto flex flex-col items-center h-screen justify-center">
      <h1 className="block bg-clip-text text-transparent font-extrabold text-4xl sm:text-5xl lg:text-6xl tracking-tight text-center pb-8 bg-gradient-to-l from-green-200 via-green-300 to-blue-500">Apa Bahasa Arabnya...</h1>
      ...
      {selectedOption && (
        <div className="bg-gray-800 overflow-hidden rounded-lg border border-gray-700 p-4 shadow-sm transition hover:shadow-primary cursor-default">
          {selectedOption?.image ? <Image className="aspect-[4/3] rounded-lg object-cover object-center" src={selectedOption.image} width={200} height={200} alt="gambar" /> : ''}
